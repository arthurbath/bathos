...
- **THEN** it preserves the user's caret or selection by exact source offset, defers decoration during composition, accepts pasted content as plain text, yields documented undo and redo commands to Tasks, and autosaves the identical source to the same notes field
