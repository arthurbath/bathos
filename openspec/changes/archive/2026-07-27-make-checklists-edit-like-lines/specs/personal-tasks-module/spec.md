...
- **THEN** Tasks saves the current accepted text, inserts and focuses one new empty checklist-item input immediately below the current item, places the caret at the beginning of the new item, and keeps the task editor open
