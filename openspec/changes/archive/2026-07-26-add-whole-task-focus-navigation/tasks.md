...
## 9. Open-Task Selection Seeding

- [x] 9.1 Treat an open task as the selection anchor when a modified click adds another task
- [x] 9.2 Keep the remaining task closed when multi-selection contracts to one selected task
- [x] 9.3 Run focused interaction, lint, typecheck, build, and strict OpenSpec validation

## 10. Explicit Single-Task Pointer Selection

- [x] 10.1 Revise the focus contract so every modified click immediately enters explicit selection mode
- [x] 10.2 Retain the toolbar and selection controls when explicit selection contains one task
- [x] 10.3 Seed a later modified-click selection from lightweight keyboard focus
- [x] 10.4 Run focused, full, lint, build, and strict OpenSpec validation
