...
#### Scenario: Do not convert a row drag into an edit click
- **WHEN** a selected checklist row begins a native drag
- **THEN** Tasks preserves checklist selection throughout the drag and does not focus the dragged row's input through the ordinary click path
