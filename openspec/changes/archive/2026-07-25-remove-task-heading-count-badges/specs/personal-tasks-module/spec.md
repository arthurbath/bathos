...
The interface SHALL present Tasks list and grouping headings without item-count adornments, SHALL keep every collapsed to-do at a dense uniform height, and SHALL bound primary planning items with subtle individual rounded rectangles.
