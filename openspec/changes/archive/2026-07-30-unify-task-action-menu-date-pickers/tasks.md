...
## 4. Repeated Deadline Advancement

- [x] 4.1 Route repeated Deadline commands to the active Deadline calendar without toggling its surface closed.
- [x] 4.2 Advance Deadline focus one day at a time across month boundaries without committing metadata.
- [x] 4.3 Add regression coverage for anchored and open-editor Deadline command entry points.
