...
- **Blast radius**: No task schema, Supabase migration, PowerSync stream, reminder dispatcher, MCP, or Raycast changes. Shared administrator-role probing changes only its transport behavior during offline and transient-failure states.
