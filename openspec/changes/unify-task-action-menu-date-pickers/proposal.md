...
- Route the focused-task Control+E and Control+D commands through the same anchored picker surfaces while retaining the existing Start-picker advancement behavior.
