# DataGrid Longtext Specification

## Purpose

Define the shared full-content viewer behavior for DataGrid text fields designated as longtext and its use in Garage note columns.
