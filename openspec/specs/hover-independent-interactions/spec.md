# Hover-Independent Interactions Specification

## Purpose

Define the BathOS-wide interaction policy that keeps controls, information, and state feedback usable without pointer hover.
