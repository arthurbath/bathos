...
4. **Path-based routing**: Each module lives under its own URL path prefix (for example, `/budget/...`, `/drawers/...`, `/garage/...`, `/wardrobe/...`). The platform root (`/`) serves the launcher and account management.
