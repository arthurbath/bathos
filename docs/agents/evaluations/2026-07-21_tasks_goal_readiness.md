...
1. Complete the actual-device iPhone pass to verify full transport loss, the `Offline` synchronization label, queued mutation recovery, and notification delivery outside Chrome DevTools' shared-worker limitation.
