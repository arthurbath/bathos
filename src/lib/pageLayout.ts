...
export const FULL_VIEW_PAGE_BOTTOM_PADDING_CLASS = 'pb-[calc(env(safe-area-inset-bottom)+5.75rem)] md:pb-0';
export const CARD_PAGE_BOTTOM_PADDING_CLASS = 'pb-[calc(env(safe-area-inset-bottom)+5.75rem)] md:pb-6';
