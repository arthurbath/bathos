  ...
  return (
    ...
    >
      <table className="w-full caption-bottom text-xs">
        <thead className={cn(
          `z-30 ${GRID_HEADER_TONE_CLASS} ${GRID_READONLY_TEXT_CLASS} shadow-[0_1px_0_0_hsl(var(--foreground))] [&_tr]:border-b-0`,
        ...
        {footer && (
          <tfoot className={cn(
            `border-t-0 shadow-[0_-1px_0_0_hsl(var(--foreground))] ${GRID_HEADER_TONE_CLASS} ${GRID_READONLY_TEXT_CLASS} font-medium [&>tr]:last:border-b-0`,
