...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-[34] bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          className,
          "grid grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden rounded-lg max-sm:rounded-none max-sm:border-0 max-sm:left-0 max-sm:right-0 max-sm:top-[calc(var(--bathos-modal-vv-top,0px)+env(safe-area-inset-top,0px))] max-sm:h-[calc(var(--bathos-modal-vv-height,100dvh)-env(safe-area-inset-top,0px))] max-sm:max-h-[calc(var(--bathos-modal-vv-height,100dvh)-env(safe-area-inset-top,0px))] max-sm:max-w-none max-sm:translate-x-0 max-sm:translate-y-0 max-sm:!animate-none max-sm:!duration-0 max-sm:!transition-none max-sm:data-[state=closed]:!animate-none max-sm:data-[state=open]:!animate-none",
      ...
      >
        ...
        {!hideClose && (
          <DialogPrimitive.Close
            ...
            className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity data-[state=open]:bg-accent data-[state=open]:text-muted-foreground  focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none"
          >
            <X className="h-4 w-4" />
