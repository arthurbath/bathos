  ...
  return (
    <div className="flex items-center gap-1">
      ...
      {needsParam(income.frequency_type) && (
        <GridEditableCell value={income.frequency_param ?? ''} onChange={v => onChange('frequency_param', v)} type="number" navCol={4} placeholder="N" className="text-left w-8 shrink-0" />
      )}
    </div>
  );
}
